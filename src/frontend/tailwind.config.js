  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        film: {
          dark: "oklch(var(--film-dark))",
          darker: "oklch(var(--film-darker))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        amber: "0 0 30px oklch(var(--amber) / 0.2)",
        "amber-lg": "0 0 60px oklch(var(--amber) / 0.15)",
        film: "0 20px 60px rgba(0,0,0,0.6)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
